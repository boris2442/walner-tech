...
<template>
    ...
    <div class="min-h-screen flex items-center justify-center bg-gray-100 p-4">
        <div class="w-full max-w-4xl flex flex-col md:flex-row bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div
                class="w-full md:w-1/2 bg-[var(--primary-blue)] text-white p-8 flex flex-col justify-center items-center">
                ...
                <!-- <Button variant="outline" class="w-full md:w-auto bg-white text-indigo-600 hover:bg-gray-100">
            Log In
          </Button> -->
            </div>
            ...
            <div class="w-full md:w-1/2 p-8">
                ...
                <Form v-bind="RegisteredUserController.store.form()"
                    ...
                    <div class="grid gap-4">
                        ...
                        <Button type="submit" class="w-full bg-[var(--primary-blue)] text-white hover:bg-indigo-700"
                            :disabled="processing">
                    ...
                    <div class="text-center text-sm text-gray-500">
                        Already have an account? <TextLink :href="login()"
                            class="text-[var(--primary-blue)] hover:underline" :tabindex="5">Log in</TextLink>
                    </div>
                </Form>
            </div>
        </div>
