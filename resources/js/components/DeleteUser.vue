                ...
                <DialogContent>
                    <Form v-bind="ProfileController.destroy.form()" reset-on-success
                        ...
                        <DialogHeader class="space-y-3">
                            ...
                            <DialogDescription>
                                Une fois votre compte supprimé, toutes ses ressources et données seront également
                                supprimées définitivement. Veuillez saisir votre mot de passe pour confirmer la
                        ...
                        <DialogFooter class="gap-2">
                            ...
                            <Button type="submit" variant="destructive" :disabled="processing"> Supprimer le
                                compte</Button>
                        </DialogFooter>
                    </Form>
                </DialogContent>
